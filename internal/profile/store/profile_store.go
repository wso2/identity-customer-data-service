...
func GetProfileIDsWithFilters(orgHandle string, filters []string) ([]string, error) {
	...
	baseSQL := scripts.GetProfileIDsWithFiltersBase.GetQuery(dbClient.DBType())
	...
	results, err := dbClient.ExecuteQuery(scripts.GetProfileIDsWithFiltersBase.WithSQL(finalSQL), args...)
	if err != nil {
